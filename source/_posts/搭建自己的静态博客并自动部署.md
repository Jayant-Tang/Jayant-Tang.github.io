...
| 部件 | 作用 |
| --- | --- |
| [Hexo](https://hexo.io/zh-cn/) | 把 Markdown 文章编译为静态站点html文件（输出到 `public/`） |
...
在仓库根目录创建 `.github/workflows/main.yml`。下面是**仅负责 Pages 发布**的最小示例（与仓库内 [完整工作流](https://github.com/Jayant-Tang/Jayant-Tang.github.io/blob/master/.github/workflows/main.yml) 相比，省略了博客园同步、缓存等步骤）：
...
本仓库的 `scaffolds/post.md` 已预置 Typora 图片路径和博客园同步字段，新建文章会自动带上。
