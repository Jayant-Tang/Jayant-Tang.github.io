...
cnblogs:
  postId: '18802161'
  url: https://www.cnblogs.com/jayant97/articles/18802161
  postType: Article
---
...
增加一个和`wifis`同级别的`ethernets`部分。配置静态IP地址为`192.168.10.1/24`，**注意不要和你的校园网/企业网的网段冲突**。如果存在冲突，可以换成其他网段。
...
![image-20260904154034551](https://jayant-blog-imgs.oss-cn-hangzhou.aliyuncs.com/undefined13c7c1ad2f5aff34a5275081b8813812.png)

右键“以太网”，选择“属性”。找到 **Internet 协议版本 4 (TCP/IPv4)** 和 **Internet 协议版本 6 (TCP/IPv6)**

![image-20260904154151234](https://jayant-blog-imgs.oss-cn-hangzhou.aliyuncs.com/undefined8529146359359a7435751ddc06162a63.png)

分别对 IPv4 和 IPv6 选择“属性”——“高级”。

![image-20260904154329840](https://jayant-blog-imgs.oss-cn-hangzhou.aliyuncs.com/undefinedaac0fa6022b51327416e4374e4125d7d.png)

取消勾选 自动跃点，在 接口跃点数 填 60。



一路确定。IPv6 同理（选 TCP/IPv6 重复一遍）

效果：优先使用 Wi-Fi 而不是网口来访问互联网。
...
其中Wi-Fi网卡是`wlp0s20f3`，以太网口是`enp0s31f6`。Wi-Fi网卡的优先级比以太网口低。
